...
public class PrescriptionController {
  ...
  @PostMapping("/create")
  public ResponseEntity<ResponseDTO> createPrescription(@RequestBody PrescriptionDTO dto) {
      ...
      return ResponseEntity
          .ok(new ResponseDTO(PrescriptionConstants.PRESCRIPTION_CREATED, PrescriptionConstants.STATUS_201));
  }
  ...
  public ResponseEntity<PrescriptionDetailDTO> detail(@RequestHeader("neuromed-correlation-id") String correlationId , @PathVariable Long id ) {
  ...
  public ResponseEntity<ResponseDTO> reorder(@RequestBody ReorderRequestDTO dto) {
    ...
    return ResponseEntity.ok(new ResponseDTO(PrescriptionConstants.PRESCRIPTION_REORDERED, PrescriptionConstants.STATUS_200));
  }
}
